...
Wire Wire Line
	6050 2225 4700 2225
$Comp
L GND-RESCUE-Arduino_Uno_R3_From_Scratch #PWR010
U 1 1 55E9684A
P 5700 2875
F 0 "#PWR010" H 5700 2875 30  0001 C CNN
...
U 1 1 56206FF2
P 5700 4975
F 0 "#PWR011" H 5700 4975 30  0001 C CNN
...
F 6 "~" H 5700 4975 60  0001 C CNN "Notes"
	...
	1    0    0    -1  
$EndComp
Text GLabel 4700 2225 0    60   Input ~ 0
328P_RESET
Text GLabel 5100 1875 1    60   Input ~ 0
VIN
Text GLabel 5400 1875 1    60   Input ~ 0
3V3_LDO
Text GLabel 5700 1875 1    60   Input ~ 0
5V_LDO
Text GLabel 4775 3275 0    60   Input ~ 0
ARD_AN3
Text GLabel 4775 3375 0    60   Input ~ 0
ARD_AN2
Text GLabel 4775 3475 0    60   Input ~ 0
ARD_AN1
Text GLabel 4775 3575 0    60   Input ~ 0
ARD_AN0
Text GLabel 4775 3925 0    60   Input ~ 0
ARD_AN5/SCL
Text GLabel 4775 4025 0    60   Input ~ 0
ARD_AN4/SDA
Text GLabel 4775 4125 0    60   Input ~ 0
AREF
Text GLabel 4775 4325 0    60   Input ~ 0
ARD_DIG13/SPI_SCK
Text GLabel 4775 4425 0    60   Input ~ 0
ARD_DIG12/SPI_MISO
Text GLabel 4775 4525 0    60   Input ~ 0
ARD_DIG11/SPI_MOSI
Text GLabel 4775 4625 0    60   Input ~ 0
ARD_DIG10/SPI_SS
Text GLabel 4775 4725 0    60   Input ~ 0
ARD_DIG9
Text GLabel 4775 4825 0    60   Input ~ 0
ARD_DIG8
Text GLabel 4775 5175 0    60   Input ~ 0
ARD_DIG7
Text GLabel 4775 5275 0    60   Input ~ 0
ARD_DIG6
Text GLabel 4775 5375 0    60   Input ~ 0
ARD_DIG5
Text GLabel 4775 5475 0    60   Input ~ 0
ARD_DIG4
Text GLabel 4775 5575 0    60   Input ~ 0
ARD_DIG3
Text GLabel 4775 5675 0    60   Input ~ 0
ARD_DIG2
Text GLabel 4775 5775 0    60   Input ~ 0
ARD_DIG1
Text GLabel 4775 5875 0    60   Input ~ 0
ARD_DIG0
$EndSCHEMATC
