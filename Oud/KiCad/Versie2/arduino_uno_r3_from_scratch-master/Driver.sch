...
U 1 1 5A0B4BA1
P 4250 3300
F 0 "#PWR022" H 4250 3050 50  0001 C CNN
...
U 1 1 5A0B5004
P 7650 3050
F 0 "#PWR025" H 7650 2800 50  0001 C CNN
...
U 1 1 5A0B4B28
P 5250 2700
F 0 "U6" H 5250 2700 60  0000 C CNN
F 1 "L298" H 5250 2800 60  0000 C CNN
F 2 "L298" H 5450 3300 60  0000 C CNN
...
U 1 1 5A0B56EE
P 3800 3300
F 0 "#PWR026" H 3800 3050 50  0001 C CNN
...
U 1 1 5A0B58F7
P 3100 3000
F 0 "U7" H 3295 3115 50  0000 C CNN
...
U 1 1 5A0B5AAE
P 3050 3300
F 0 "#PWR027" H 3050 3050 50  0001 C CNN
...
NoConn ~ 4400 2400
NoConn ~ 6100 2400
Text GLabel 6675 3100 3    60   Input ~ 0
ARD_DIG11/SPI_MOSI
Wire Wire Line
	3425 2725 3425 2900
Text GLabel 3625 2725 1    60   Input ~ 0
ARD_DIG12/SPI_MISO
Wire Wire Line
	3625 2725 3625 2800
Text GLabel 6475 3100 3    60   Input ~ 0
ARD_DIG13/SPI_SCK
Text GLabel 3425 2725 1    60   Input ~ 0
ARD_DIG3
Wire Wire Line
	6475 2900 6475 3100
Wire Wire Line
	6675 2800 6675 3100
Text GLabel 6625 2325 1    60   Input ~ 0
OUT4
Text GLabel 6800 2325 1    60   Input ~ 0
OUT3
Text GLabel 3800 2375 1    60   Input ~ 0
OUT2
Text GLabel 4000 2375 1    60   Input ~ 0
OUT1
Wire Wire Line
	4000 2375 4000 2500
Wire Wire Line
...
5V_LDO
Text GLabel 6300 2050 1    60   Input ~ 0
5V_LDO
Text GLabel 7150 3100 3    60   Input ~ 0
5V_LDO
$Comp
L GND #PWR029
U 1 1 5A8DAF91
P 5250 3450
F 0 "#PWR029" H 5250 3200 50  0001 C CNN
